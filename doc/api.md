...
| `entityNameExp`                | ✓        | string         |            | optional field to allow use expressions to define entity name, instead default name, based on the device id and the entity type (`<device_id>:<entity_type>`)                                                                                                                                                                            |
