...
-   **skipValue**: indicates the value to discard attribute of be sent ti CB when as a result of `expression`. By
    default if skipValue is not defined then is considered as `null`.
