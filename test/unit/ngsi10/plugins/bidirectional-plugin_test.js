...
describe('Bidirectional data plugin', function() {
    var options = {
        ...
        method: 'POST',
        json:
            utils.readExampleFile('./test/unit/ngsi10/examples/deviceProvisioningRequests/provisionBidirectionalDevice.json'),
        headers: {
        ...
        beforeEach(function() {
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v1/subscribeContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/subscriptionRequests/bidirectionalSubscriptionRequest.json'))
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi10/examples/subscriptionResponses/bidirectionalSubscriptionSuccess.json'));

            contextBrokerMock
                .matchHeader('fiware-service', 'smartGondor')
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v1/updateContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextRequests/createBidirectionalDevice.json'))
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextResponses/createBidirectionalDeviceSuccess.json'));
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v1/unsubscribeContext', utils.readExampleFile(
                        './test/unit/ngsi10/examples/subscriptionRequests/simpleSubscriptionRemove.json'))
                .reply(200, utils.readExampleFile(
                        './test/unit/ngsi10/examples/subscriptionResponses/bidirectionalSubscriptionSuccess.json'));
        });
    ...
    describe('When a notification arrives for a bidirectional attribute', function() {
        var notificationOptions = {
                ...
                method: 'POST',
                json: utils.readExampleFile('./test/unit/ngsi10/examples/subscriptionRequests/bidirectionalNotification.json'),
                headers: {
                    'fiware-service': 'smartGondor',
                    'fiware-servicepath': '/gardens'
                }
    ...
    describe('When a new Group provisioning request arrives with bidirectional attributes', function() {
        var provisionGroup = {
                ...
                method: 'POST',
                json:
                    utils.readExampleFile('./test/unit/ngsi10/examples/groupProvisioningRequests/bidirectionalGroup.json'),
                headers: {
                    'fiware-service': 'smartGondor',
                    'fiware-servicepath': '/gardens'
                }
            ...
            provisionDevice = {
                ...
                json: utils.readExampleFile(
                    './test/unit/ngsi10/examples/deviceProvisioningRequests/provisionDeviceBidirectionalGroup.json'),
                headers: {
                    'fiware-service': 'smartGondor',
                    'fiware-servicepath': '/gardens'
                }
