        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v1/updateContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextRequests/updateContextProcessTimestamp1.json'))
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextResponses/updateContextProcessTimestamp1Success.json'));
        });
