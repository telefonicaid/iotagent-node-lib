        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v1/updateContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextRequests/updateContextCompressTimestamp1.json'))
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextResponses/updateContextCompressTimestamp1Success.json'));
        });
    ...
    describe('When an update comes with a timestamp through the plugin with metadatas', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v1/updateContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextRequests/updateContextCompressTimestamp2.json'))
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextResponses/updateContextCompressTimestamp2Success.json'));
        });
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v1/queryContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextRequests/queryContextCompressTimestamp1.json'))
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextResponses/queryContextCompressTimestamp1Success.json'));
        });
