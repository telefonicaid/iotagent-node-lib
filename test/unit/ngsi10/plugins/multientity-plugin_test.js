        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v1/updateContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextRequests/updateContextMultientityPlugin1.json'))
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextResponses/updateContextMultientityPlugin1Success.json'));
        });
    ...
    describe('When an update comes for a multientity defined with an expression', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v1/updateContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextRequests/updateContextMultientityPlugin3.json'))
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextResponses/updateContextMultientityPlugin3Success.json'));
        });
    ...
    describe('When an update comes for a multientity measurement without type for one entity', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v1/updateContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextRequests/updateContextMultientityPlugin2.json'))
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextResponses/updateContextMultientityPlugin2Success.json'));
        });
