    ...
    describe('When a measure is sent to the Context Broker via an Update Context operation', function() {
        beforeEach(function(done) {
            ...
            keystoneMock = nock('http://128.16.109.11:5000')
                .post('/v3/auth/tokens',
                utils.readExampleFile('./test/unit/ngsi10/examples/keystoneRequests/getTokenFromTrust.json'))
                .reply(
                    201,
                    utils.readExampleFile('./test/unit/ngsi10/examples/keystoneResponses/tokenFromTrust.json'),
                    {
    ...
    describe('When a measure is sent and the trust is rejected asking for the token', function() {
        beforeEach(function(done) {
            ...
            keystoneMock = nock('http://128.16.109.11:5000')
                ...
                .reply(
                401,
                utils.readExampleFile('./test/unit/ngsi10/examples/keystoneResponses/tokenFromTrustUnauthorized.json'));
    ...
    describe('When the user requests information about a device in a protected CB', function() {
        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                utils.readExampleFile('./test/unit/ngsi10/examples/contextRequests/queryContext1.json'))
                .reply(200,
                utils.readExampleFile('./test/unit/ngsi10/examples/contextResponses/queryContext1Success.json'));
