...
describe('IoT Agent Device Update Registration', function() {
    beforeEach(function(done) {
        ...
        contextBrokerMock = nock('http://192.168.1.1:1026')
            ...
            .reply(200, utils.readExampleFile(
                './test/unit/ngsi10/examples/contextAvailabilityResponses/registerIoTAgent1Success.json'));
        ...
        beforeEach(function() {
            contextBrokerMock
                .post('/NGSI9/registerContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextAvailabilityRequests/updateIoTAgent1.json'))
                .reply(200, utils.readExampleFile(
            ...
            contextBrokerMock
                ...
                .post('/v1/updateContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextRequests/updateProvisionActiveAttributes1.json'))
                .reply(200,
                    utils.readExampleFile(
                        './test/unit/ngsi10/examples/contextResponses/updateProvisionActiveAttributes1Success.json'));
        });
    ...
    describe('When a device is preregistered and it is updated with new commands', function() {
        beforeEach(function() {
            contextBrokerMock
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v1/updateContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextRequests/updateProvisionCommands1.json'))
                .reply(200,
                    utils.readExampleFile(
                        './test/unit/ngsi10/examples/contextResponses/updateProvisionCommands1Success.json'));

            contextBrokerMock
                .post('/NGSI9/registerContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextAvailabilityRequests/updateCommands1.json'))
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextAvailabilityResponses/updateCommands1Success.json'));
        });
    ...
    describe('When a device register is updated in the Context Broker and the request fail to connect', function() {
        beforeEach(function() {
            contextBrokerMock
                .post('/NGSI9/registerContext',
                utils.readExampleFile('./test/unit/ngsi10/examples/contextAvailabilityRequests/updateIoTAgent1.json'))
                .reply(500, {});
