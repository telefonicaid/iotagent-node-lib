...
describe('Device provisioning API: List provisioned devices', function() {
    ...
    beforeEach(function(done) {
        ...
        provisioning4Options = {
            ...
            json: utils.readExampleFile('./test/unit/ngsi10/examples/deviceProvisioningRequests/provisionFullDevice.json')
        };
        ...
        beforeEach(function(done) {
            provisioning3Options = {
                ...
                json: utils.readExampleFile(
                    './test/unit/ngsi10/examples/deviceProvisioningRequests/provisionYetAnotherDevice.json')
            };
