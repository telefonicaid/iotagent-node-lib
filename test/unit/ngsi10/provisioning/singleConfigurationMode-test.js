...
var iotAgentLib = require('../../../../lib/fiware-iotagent-lib'),
    ...
    groupCreation = {
        ...
        method: 'POST',
        json: utils.readExampleFile('./test/unit/ngsi10/examples/groupProvisioningRequests/provisionFullGroup.json'),
        headers: {
...
describe('Provisioning API: Single service mode', function() {
    ...
    describe('When a new configuration arrives to an already configured subservice', function() {
        var groupCreationDuplicated = {
            url: 'http://localhost:4041/iot/services',
            method: 'POST',
            json: utils.readExampleFile('./test/unit/ngsi10/examples/groupProvisioningRequests/provisionDuplicateGroup.json'),
            headers: {
                'fiware-service': 'TestService',
                'fiware-servicepath': '/testingPath'
            }
    ...
    describe('When a device is provisioned with an ID that already exists in the configuration', function() {
        var deviceCreationDuplicated = {
            url: 'http://localhost:' + iotAgentConfig.server.port + '/iot/devices',
            method: 'POST',
            json: utils.readExampleFile('./test/unit/ngsi10/examples/deviceProvisioningRequests/provisionDuplicatedDev.json'),
            headers: {
                'fiware-service': 'TestService',
                'fiware-servicepath': '/testingPath'
            }
        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/NGSI9/registerContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextAvailabilityRequests/registerProvisionedDeviceWithGroup.json'))
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextAvailabilityResponses/registerProvisionedDeviceSuccess.json'));
            ...
            contextBrokerMock
                ...
                .post('/v1/updateContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextRequests/createProvisionedDeviceWithGroupAndStatic.json'))
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextResponses/createProvisionedDeviceSuccess.json'));
