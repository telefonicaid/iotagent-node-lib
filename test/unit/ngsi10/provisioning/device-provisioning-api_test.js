...
describe('Device provisioning API: Provision devices', function() {
        ...
        iotAgentLib.activate(iotAgentConfig, function() {
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/NGSI9/registerContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextAvailabilityRequests/registerProvisionedDevice.json'))
                .reply(200, utils.readExampleFile(
                        './test/unit/ngsi10/examples/contextAvailabilityResponses/registerProvisionedDeviceSuccess.json'));
            ...
            contextBrokerMock
                ...
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextResponses/createProvisionedDeviceSuccess.json'));
    ...
    describe('When a device provisioning request with all the required data arrives to the IoT Agent', function() {
        beforeEach(function() {
            ...
            contextBrokerMock
                ...
                .post('/v1/updateContext', utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextRequests/createProvisionedDevice.json'))
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextResponses/createProvisionedDeviceSuccess.json'));
        });
        ...
        var options = {
            ...
            method: 'POST',
            json: utils.readExampleFile('./test/unit/ngsi10/examples/deviceProvisioningRequests/provisionNewDevice.json'),
            headers: {
    ...
    describe('When a device provisioning request with a TimeInstant attribute arrives to the IoTA', function() {
        var options = {
            url: 'http://localhost:' + iotAgentConfig.server.port + '/iot/devices',
            method: 'POST',
            json: utils.readExampleFile('./test/unit/ngsi10/examples/deviceProvisioningRequests/provisionTimeInstant.json'),
            headers: {
                'fiware-service': 'smartGondor',
                'fiware-servicepath': '/gardens'
            }
        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v1/updateContext',
                    utils.readExampleFile('./test/unit/ngsi10/examples/contextRequests/createTimeinstantDevice.json'))
                .reply(200,
                    utils.readExampleFile('./test/unit/ngsi10/examples/contextResponses/createTimeinstantSuccess.json'));
    ...
    describe('When a device provisioning request with the minimum required data arrives to the IoT Agent', function() {
        var options = {
            url: 'http://localhost:' + iotAgentConfig.server.port + '/iot/devices',
            method: 'POST',
            json: utils.readExampleFile('./test/unit/ngsi10/examples/deviceProvisioningRequests/provisionMinimumDevice.json'),
            headers: {
                'fiware-service': 'smartGondor',
                'fiware-servicepath': '/gardens'
            }
        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v1/updateContext',
                    utils.readExampleFile('./test/unit/ngsi10/examples/contextRequests/createMinimumProvisionedDevice.json'))
                .reply(200,
                    utils.readExampleFile('./test/unit/ngsi10/examples/contextResponses/createProvisionedDeviceSuccess.json'));
    ...
    describe('When a device provisioning request with geo:point attributes arrives', function() {
        var options = {
            url: 'http://localhost:' + iotAgentConfig.server.port + '/iot/devices',
            method: 'POST',
            json: utils.readExampleFile('./test/unit/ngsi10/examples/deviceProvisioningRequests/provisionGeopointDevice.json'),
            headers: {
                'fiware-service': 'smartGondor',
                'fiware-servicepath': '/gardens'
            }
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v1/updateContext',
                    utils.readExampleFile(
                        './test/unit/ngsi10/examples/contextRequests/createGeopointProvisionedDevice.json'))
                .reply(200,
                    utils.readExampleFile(
                        './test/unit/ngsi10/examples/contextResponses/createGeopointProvisionedDeviceSuccess.json'));
    ...
    describe('When a device provisioning request with DateTime attributes arrives', function() {
        var options = {
            url: 'http://localhost:' + iotAgentConfig.server.port + '/iot/devices',
            method: 'POST',
            json: utils.readExampleFile('./test/unit/ngsi10/examples/deviceProvisioningRequests/provisionDatetimeDevice.json'),
            headers: {
                'fiware-service': 'smartGondor',
                'fiware-servicepath': '/gardens'
            }
        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v1/updateContext',
                    utils.readExampleFile(
                        './test/unit/ngsi10/examples/contextRequests/createDatetimeProvisionedDevice.json'))
                .reply(200,
                    utils.readExampleFile(
                        './test/unit/ngsi10/examples/contextResponses/createDatetimeProvisionedDeviceSuccess.json'));
    ...
    describe('When two devices with the same ID but different services arrive to the agent', function() {
        var options1 = {
                ...
                json: utils.readExampleFile(
                    './test/unit/ngsi10/examples/deviceProvisioningRequests/provisionMinimumDevice.json'),
                headers: {
                    'fiware-service': 'smartGondor',
                    'fiware-servicepath': '/gardens'
                }
    ...
    describe('When a device provisioning request with missing data arrives to the IoT Agent', function() {
        var options = {
            ...
            json: utils.readExampleFile(
                './test/unit/ngsi10/examples/deviceProvisioningRequests/provisionDeviceMissingParameters.json')
        };
    ...
    describe('When a device provisioning request is malformed', function() {
        var options = {
            ...
            method: 'POST',
            json: utils.readExampleFile(
                './test/unit/ngsi10/examples/deviceProvisioningRequests/provisionNewDeviceMalformed1.json'),
            headers: {
                'fiware-service': 'smartGondor',
                'fiware-servicepath': '/gardens'
            }
