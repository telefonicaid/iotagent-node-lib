        ...
        contextBrokerMock = nock('http://192.168.1.1:1026')
            ...
            .post('/NGSI9/registerContext',
                utils.readExampleFile(
                    './test/unit/ngsi10/examples/contextAvailabilityRequests/registerIoTAgentCommands.json'))
            .reply(200,
                utils.readExampleFile(
    ...
    describe('When a command update arrives to the IoT Agent for a device with polling', function() {
        ...
        beforeEach(function(done) {
            statusAttributeMock = nock('http://192.168.1.1:1026')
                ...
                .reply(200,
                    utils.readExampleFile(
                        './test/unit/ngsi10/examples/contextResponses/updateContextCommandStatusSuccess.json'));
    ...
    describe('When a polling command expires', function() {
        ...
        beforeEach(function(done) {
            ...
            statusAttributeMock
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v1/updateContext',
                    utils.readExampleFile('./test/unit/ngsi10/examples/contextRequests/updateContextCommandExpired.json'))
                .reply(200,
                    utils.readExampleFile(
                        './test/unit/ngsi10/examples/contextResponses/updateContextCommandStatusSuccess.json'));
