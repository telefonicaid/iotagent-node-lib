...
describe('Command functionalities', function() {
    beforeEach(function(done) {
        ...
        contextBrokerMock = nock('http://192.168.1.1:1026')
            ...
            utils.readExampleFile('./test/unit/ngsi10/examples/contextAvailabilityRequests/registerIoTAgentCommands.json'))
            .reply(200,
            utils.readExampleFile('./test/unit/ngsi10/examples/contextAvailabilityResponses/registerIoTAgent1Success.json'));
    ...
    describe('When a command update arrives to the IoT Agent as Context Provider', function() {
        ...
        beforeEach(function(done) {
            statusAttributeMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v1/updateContext',
                utils.readExampleFile('./test/unit/ngsi10/examples/contextRequests/updateContextCommandStatus.json'))
                .reply(200,
                utils.readExampleFile('./test/unit/ngsi10/examples/contextResponses/updateContextCommandStatusSuccess.json'));
    ...
    describe('When an update arrives from the south bound for a registered command', function() {
        beforeEach(function(done) {
            statusAttributeMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v1/updateContext',
                utils.readExampleFile('./test/unit/ngsi10/examples/contextRequests/updateContextCommandFinish.json'))
                .reply(200,
                utils.readExampleFile('./test/unit/ngsi10/examples/contextResponses/updateContextCommandFinishSuccess.json'));
    ...
    describe('When an error command arrives from the south bound for a registered command', function() {
        beforeEach(function(done) {
            statusAttributeMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v1/updateContext',
                utils.readExampleFile('./test/unit/ngsi10/examples/contextRequests/updateContextCommandError.json'))
                .reply(200,
                utils.readExampleFile('./test/unit/ngsi10/examples/contextResponses/updateContextCommandStatusSuccess.json'));
