    ...
    describe('When the user requests information about a device that it\'s not in the CB', function() {
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v1/queryContext',
                utils.readExampleFile('./test/unit/ngsi10/examples/contextRequests/queryContext2.json'))
                .reply(200,
                utils.readExampleFile('./test/unit/ngsi10/examples/contextResponses/queryContext2Error.json'));
    ...
    describe('When the user requests information and there are multiple responses, one of them a failure', function() {
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                utils.readExampleFile('./test/unit/ngsi10/examples/contextRequests/queryContext2.json'))
                .reply(200,
                utils.readExampleFile('./test/unit/ngsi10/examples/contextResponses/queryContext3Error.json'));
    ...
    describe('When the user requests information and there is an unknown errorCode in the response', function() {
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                utils.readExampleFile('./test/unit/ngsi10/examples/contextRequests/queryContext2.json'))
                .reply(200,
                utils.readExampleFile('./test/unit/ngsi10/examples/contextResponses/queryContext2UnknownError.json'));
