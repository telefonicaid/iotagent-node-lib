        ...
        iotAgentLib.activate(iotAgentConfig, function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v1/subscribeContext',
                    utils.readExampleFile('./test/unit/ngsi10/examples/subscriptionRequests/simpleSubscriptionRequest.json'))
                .reply(200,
                    utils.readExampleFile('./test/unit/ngsi10/examples/subscriptionResponses/simpleSubscriptionSuccess.json'));
        ...
        beforeEach(function(done) {
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v1/unsubscribeContext',
                    utils.readExampleFile('./test/unit/ngsi10/examples/subscriptionRequests/simpleSubscriptionRemove.json'))
                .reply(200,
                    utils.readExampleFile('./test/unit/ngsi10/examples/subscriptionResponses/simpleSubscriptionSuccess.json'));
    ...
    describe('When a new notification comes to the IoTAgent', function() {
        ...
        it('should invoke the user defined callback', function(done) {
            var notificationOptions = {
                    ...
                    method: 'POST',
                    json: utils.readExampleFile('./test/unit/ngsi10/examples/subscriptionRequests/simpleNotification.json'),
                    headers: {
                        'fiware-service': 'smartGondor',
                        'fiware-servicepath': '/gardens'
                    }
    ...
    describe('When a new notification arrives to the IOTA with a non-200 code', function() {
        it('should not call the handler', function(done) {
            var notificationOptions = {
                    url: 'http://localhost:' + iotAgentConfig.server.port + '/notify',
                    method: 'POST',
                    json: utils.readExampleFile('./test/unit/ngsi10/examples/subscriptionRequests/errorNotification.json'),
                    headers: {
                        'fiware-service': 'smartGondor',
                        'fiware-servicepath': '/gardens'
                    }
