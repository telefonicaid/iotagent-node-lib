        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v2/entities/light1/attrs', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextRequests/updateContextExpressionPlugin1.json'))
                .reply(204);
        });
    ...
    describe('When an update comes for expressions with syntax errors', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v2/entities/light1/attrs', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextRequests/updateContextExpressionPlugin4.json'))
                .reply(204);
        });
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v2/entities/ws1/attrs', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextRequests/updateContextExpressionPlugin2.json'))
                .reply(204);
        });
    ...
    describe('When an expression with multiple variables with numbers arrive', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v2/entities/ws1/attrs', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextRequests/updateContextExpressionPlugin5.json'))
                .reply(204);
        });
    ...
    describe('When a measure arrives and there is not enough information to calculate an expression', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v2/entities/ws1/attrs', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextRequests/updateContextExpressionPlugin3.json'))
                .reply(204);
        });
