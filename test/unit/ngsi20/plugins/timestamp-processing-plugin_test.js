    ...
    beforeEach(function(done) {
        ...
        iotAgentLib.activate(iotAgentConfig, function() {
            iotAgentLib.clearAll(function() {
                iotAgentLib.addUpdateMiddleware(iotAgentLib.dataPluginsNgsi2.timestampProcess.update);
                done();
            });
        });
    });
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v2/entities/light1/attrs', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextRequests/updateContextProcessTimestamp1.json'))
                .reply(204);
        });
