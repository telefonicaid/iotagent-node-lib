    ...
    beforeEach(function(done) {
        ...
        iotAgentLib.activate(iotAgentConfig, function() {
            iotAgentLib.clearAll(function() {
                iotAgentLib.addUpdateMiddleware(iotAgentLib.dataPluginsNgsi2.compressTimestamp.update);
                iotAgentLib.addQueryMiddleware(iotAgentLib.dataPluginsNgsi2.compressTimestamp.query);
                done();
            });
        });
    });
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v2/entities/light1/attrs', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextRequests/updateContextCompressTimestamp1.json'))
                .reply(204);
        });
    ...
    describe('When an update comes with a timestamp through the plugin with metadata', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v2/entities/light1/attrs', utils.readExampleFile(
                './test/unit/ngsi20/examples/contextRequests/updateContextCompressTimestamp2.json'))
                .reply(204);
        });
    ...
    describe('When a query comes for a timestamp through the plugin', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                .matchHeader('fiware-service', 'smartGondor')
                .matchHeader('fiware-servicepath', 'gardens')
                .get('/v2/entities/light1?attrs=state,The%20Target%20Value')
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextResponses/queryContextCompressTimestamp1Success.json'));
        });
