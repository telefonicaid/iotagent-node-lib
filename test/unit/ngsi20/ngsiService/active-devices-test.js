    ...
    describe('When the IoT Agent receives new information from a device and the appendMode flag is on', function() {
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v2/entities/light1/attrs',
                utils.readExampleFile('./test/unit/ngsi20/examples/contextRequests/updateContextAppendMode.json'))
                .reply(204);
    ...
    describe('When the IoTA gets a set of values with a TimeInstant and the timestamp flag is on', function() {
        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v2/entities/light1/attrs',
                    utils.readExampleFile('./test/unit/ngsi20/examples/contextRequests/updateContextTimestampOverride.json'))
                .reply(204);
