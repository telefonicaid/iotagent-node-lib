...
describe('IoT Agent Device Update Registration', function() {
        ...
        beforeEach(function() {
            contextBrokerMock
                .post('/NGSI9/registerContext', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityRequests/updateIoTAgent1.json'))
                .reply(200, utils.readExampleFile(
            ...
            contextBrokerMock
                ...
                .post('/v2/entities', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextRequests/updateProvisionActiveAttributes1.json'))
                .reply(201);
        });
    ...
    describe('When a device is preregistered and it is updated with new commands', function() {
        beforeEach(function() {
            contextBrokerMock
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v2/entities', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextRequests/updateProvisionCommands1.json'))
                .reply(201);

            contextBrokerMock
                .post('/NGSI9/registerContext', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityRequests/updateCommands1.json'))
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityResponses/updateCommands1Success.json'));
        });
    ...
    describe('When a device register is updated in the Context Broker and the request fail to connect', function() {
        beforeEach(function() {
            contextBrokerMock
                .post('/NGSI9/registerContext',
                utils.readExampleFile('./test/unit/ngsi20/examples/contextAvailabilityRequests/updateIoTAgent1.json'))
                .reply(500, {});
