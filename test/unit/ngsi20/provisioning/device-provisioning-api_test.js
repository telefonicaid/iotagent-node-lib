...
describe('Device provisioning API: Provision devices', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock
                ...
                .post('/v2/entities', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextRequests/createProvisionedDevice.json'))
                .reply(201);
        });
    ...
    describe('When a device provisioning request with a TimeInstant attribute arrives to the IoTA', function() {
        var options = {
            url: 'http://localhost:' + iotAgentConfig.server.port + '/iot/devices',
            method: 'POST',
            json: utils.readExampleFile('./test/unit/ngsi20/examples/deviceProvisioningRequests/provisionTimeInstant.json'),
            headers: {
                'fiware-service': 'smartGondor',
                'fiware-servicepath': '/gardens'
            }
        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v2/entities',
                    utils.readExampleFile('./test/unit/ngsi20/examples/contextRequests/createTimeinstantDevice.json'))
                .reply(200);
    ...
    describe('When a device provisioning request with geo:point attributes arrives', function() {
        var options = {
            url: 'http://localhost:' + iotAgentConfig.server.port + '/iot/devices',
            method: 'POST',
            json: utils.readExampleFile('./test/unit/ngsi20/examples/deviceProvisioningRequests/provisionGeopointDevice.json'),
            headers: {
                'fiware-service': 'smartGondor',
                'fiware-servicepath': '/gardens'
            }
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v2/entities',
                    utils.readExampleFile(
                        './test/unit/ngsi20/examples/contextRequests/createGeopointProvisionedDevice.json'))
                .reply(201);
    ...
    describe('When a device provisioning request with DateTime attributes arrives', function() {
        var options = {
            url: 'http://localhost:' + iotAgentConfig.server.port + '/iot/devices',
            method: 'POST',
            json: utils.readExampleFile('./test/unit/ngsi20/examples/deviceProvisioningRequests/provisionDatetimeDevice.json'),
            headers: {
                'fiware-service': 'smartGondor',
                'fiware-servicepath': '/gardens'
            }
        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v2/entities',
                    utils.readExampleFile(
                        './test/unit/ngsi20/examples/contextRequests/createDatetimeProvisionedDevice.json'))
                .reply(201);
    ...
    describe('When two devices with the same ID but different services arrive to the agent', function() {
        var options1 = {
                ...
                json: utils.readExampleFile(
                    './test/unit/ngsi20/examples/deviceProvisioningRequests/provisionMinimumDevice.json'),
                headers: {
                    'fiware-service': 'smartGondor',
                    'fiware-servicepath': '/gardens'
                }
    ...
    describe('When there is a connection error with a String code connecting the CB', function() {
        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock
                ...
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v2/entities')
                .replyWithError({'description': 'Description of the error', 'error': 'a textual description of the error'});
    ...
    describe('When there is a connection error with a Number code connecting the CB', function() {
        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock
                ...
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v2/entities')
                .replyWithError({'description': 'Description of the error', 'error': 123456789});
    ...
    describe('When a device provisioning request with missing data arrives to the IoT Agent', function() {
        var options = {
            ...
            json: utils.readExampleFile(
                './test/unit/ngsi20/examples/deviceProvisioningRequests/provisionDeviceMissingParameters.json')
        };
...
//                body.message.should.match(.device_id.);
    ...
    describe('When a device provisioning request is malformed', function() {
        var options = {
            ...
            method: 'POST',
            json: utils.readExampleFile(
                './test/unit/ngsi20/examples/deviceProvisioningRequests/provisionNewDeviceMalformed1.json'),
            headers: {
                'fiware-service': 'smartGondor',
                'fiware-servicepath': '/gardens'
            }
