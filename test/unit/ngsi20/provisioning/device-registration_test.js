    ...
    describe('When the Context Broker returns a NGSI error while registering a device', function() {
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                './test/unit/ngsi20/examples/contextAvailabilityRequests/registerIoTAgent1.json')*/)
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityResponses/registerIoTAgent1Failed.json'));
    ...
    describe('When a device is removed from the IoT Agent', function() {
        beforeEach(function(done) {
            var expectedPayload3 = utils
                    .readExampleFile('./test/unit/ngsi20/examples/contextAvailabilityRequests/unregisterDevice1.json');

            nock.cleanAll();
            contextBrokerMock = nock('http://192.168.1.1:1026')
                .post('/NGSI9/registerContext')
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityResponses/registerNewDevice1Success.json'));
            ...
            contextBrokerMock
                .post('/NGSI9/registerContext')
                .reply(200, utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityResponses/registerNewDevice2Success.json'));
    ...
    describe('When the Context Broker returns an error while unregistering a device', function() {
        beforeEach(function(done) {
            ...
            contextBrokerMock
                .post('/NGSI9/registerContext', expectedPayload3)
                .reply(500, utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityResponses/unregisterDevice1Failed.json'));
