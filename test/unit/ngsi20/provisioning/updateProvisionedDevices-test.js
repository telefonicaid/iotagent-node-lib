...
describe('Device provisioning API: Update provisioned devices', function() {
    var provisioning1Options = {
            ...
            json: utils.readExampleFile('./test/unit/ngsi20/examples/deviceProvisioningRequests/provisionNewDevice.json')
        },
        provisioning2Options = {
            ...
            json: utils.readExampleFile('./test/unit/ngsi20/examples/deviceProvisioningRequests/provisionAnotherDevice.json')
        },
        provisioning3Options = {
            ...
            json: utils.readExampleFile('./test/unit/ngsi20/examples/deviceProvisioningRequests/provisionMinimumDevice2.json')
        };
        ...
        iotAgentLib.activate(iotAgentConfig, function() {
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityRequests/registerProvisionedDevice.json'))
                .reply(200,
                utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityResponses/registerProvisionedDeviceSuccess.json'));
            ...
            contextBrokerMock
                ...
                .post('/NGSI9/registerContext',
                utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityRequests/registerProvisionedDevice2.json'))
                .reply(200,
                utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityResponses/registerProvisionedDeviceSuccess.json'));
            ...
            contextBrokerMock
                ...
                .post('/NGSI9/registerContext',
                utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityRequests/updateIoTAgent2.json'))
                .reply(200,
                utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityResponses/updateIoTAgent1Success.json'));
    ...
    describe('When a request to update a provision device arrives', function() {
        var optionsUpdate = {
            ...
            json: utils.readExampleFile('./test/unit/ngsi20/examples/deviceProvisioningRequests/updateProvisionDevice.json')
        };
        ...
        beforeEach(function() {
            contextBrokerMock
                ...
                .post('/v2/entities', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextRequests/updateActiveAttributes.json'))
                .reply(201);

            contextBrokerMock
                .post('/NGSI9/registerContext', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityRequests/updateIoTAgent3.json'))
    ...
    describe('When an update request arrives with a new Device ID', function() {
        var optionsUpdate = {
            ...
            json: utils.readExampleFile(
                './test/unit/ngsi20/examples/deviceProvisioningRequests/updateProvisionDeviceWithId.json')
        };
    ...
    describe('When a wrong update request payload arrives', function() {
        var optionsUpdate = {
            ...
            json: utils.readExampleFile(
                './test/unit/ngsi20/examples/deviceProvisioningRequests/updateProvisionDeviceWrong.json')
        };
    ...
    describe('When a device is provisioned without attributes and new ones are added through an update', function() {
        var optionsUpdate = {
                ...
                json: utils.readExampleFile('./test/unit/ngsi20/examples/deviceProvisioningRequests/updateMinimumDevice.json')
            },
            optionsGetDevice = {
                url: 'http://localhost:' + iotAgentConfig.server.port + '/iot/devices/MicroLight2',
                method: 'GET',
        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock
                ...
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v2/entities', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextRequests/updateProvisionMinimumDevice.json'))
                .reply(201);
    ...
    describe('When a device is updated to add static attributes', function() {
        ...
        var optionsUpdate = {
                ...
                json: utils.readExampleFile('./test/unit/ngsi20/examples/deviceProvisioningRequests/updateDeviceStatic.json')
            },
            optionsGetDevice = {
                url: 'http://localhost:' + iotAgentConfig.server.port + '/iot/devices/MicroLight2',
                method: 'GET',
        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock
                ...
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v2/entities', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextRequests/updateProvisionDeviceStatic.json'))
                .reply(201);
