    ...
    describe('When a measure is sent to the Context Broker via an Update Context operation', function() {
        beforeEach(function(done) {
            ...
            keystoneMock = nock('http://128.16.109.11:5000')
                .post('/v3/auth/tokens',
                utils.readExampleFile('./test/unit/ngsi20/examples/keystoneRequests/getTokenFromTrust.json'))
                .reply(
                    201,
                    utils.readExampleFile('./test/unit/ngsi20/examples/keystoneResponses/tokenFromTrust.json'),
                    {
    ...
    describe('When a measure is sent and the trust is rejected asking for the token', function() {
        beforeEach(function(done) {
            ...
            keystoneMock = nock('http://128.16.109.11:5000')
                ...
                .reply(
                401,
                utils.readExampleFile('./test/unit/ngsi20/examples/keystoneResponses/tokenFromTrustUnauthorized.json'));
