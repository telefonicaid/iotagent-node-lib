...
var migration = require('../../../../lib/command/migration'),
    ...
    deviceCollection = utils.readExampleFile('./test/unit/ngsi20/examples/mongoCollections/devices.json'),
    configurationCollection = utils.readExampleFile('./test/unit/ngsi20/examples/mongoCollections/configurations.json'),
    originDb,
    targetDb;
