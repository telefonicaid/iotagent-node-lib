...
describe('IoT Manager autoregistration', function() {
    describe('When the IoT Agent is started without a "iotManager" config parameter and empty services', function() {
        beforeEach(function() {
            ...
            iotamMock = nock('http://mockediotam.com:9876')
                .post('/protocols',
                    utils.readExampleFile('./test/unit/ngsi20/examples/iotamRequests/registrationEmpty.json'))
                .reply(200,
    ...
    describe('When the IoT Agents is started with "iotManager" config and multiple services', function() {
        beforeEach(function(done) {
            ...
            iotamMock = nock('http://mockediotam.com:9876')
                .post('/protocols',
                utils.readExampleFile('./test/unit/ngsi20/examples/iotamRequests/registrationWithGroups.json'))
                .reply(200,
                utils.readExampleFile('./test/unit/ngsi20/examples/iotamResponses/registrationSuccess.json'));
    ...
    describe('When a new service with static attributes is created in the IoT Agent', function() {
        beforeEach(function(done) {
            ...
            iotamMock
                .post('/protocols',
                    utils.readExampleFile('./test/unit/ngsi20/examples/iotamRequests/registrationWithStaticGroups.json'))
                .reply(200,
                    utils.readExampleFile('./test/unit/ngsi20/examples/iotamResponses/registrationSuccess.json'));
