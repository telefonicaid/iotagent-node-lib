        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/NGSI9/registerContext', utils.readExampleFile(
                    './test/unit/ngsi20/examples/contextAvailabilityRequests/registerIoTAgent3.json'))
    ...
    describe('When a device is removed from the IoT Agent', function() {
        beforeEach(function(done) {
            var expectedPayload3 = utils
                .readExampleFile('./test/unit/ngsi20/examples/contextAvailabilityRequests/unregisterDevice3.json');
