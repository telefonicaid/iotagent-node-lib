...
describe('Command functionalities', function() {
    beforeEach(function(done) {
        ...
        contextBrokerMock = nock('http://192.168.1.1:1026')
            ...
            .reply(200,
            utils.readExampleFile('./test/unit/ngsi20/examples/contextAvailabilityResponses/registerIoTAgent1Success.json'));
    ...
    describe('When a command update arrives to the IoT Agent as Context Provider', function() {
        var options = {
            url: 'http://localhost:' + iotAgentConfig.server.port + '/v2/entities/Robot:r2d2/attrs',
            method: 'POST',
            json: {
                position:{
                    type: 'Array',
        ...
        beforeEach(function(done) {
            statusAttributeMock = nock('http://192.168.1.1:1026')
                .matchHeader('fiware-service', 'smartGondor')
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v2/entities/Robot:r2d2/attrs',
                utils.readExampleFile('./test/unit/ngsi20/examples/contextRequests/updateContextCommandStatus.json'))
                .reply(204);
    ...
    describe('When an update arrives from the south bound for a registered command', function() {
        beforeEach(function(done) {
            statusAttributeMock = nock('http://192.168.1.1:1026')
                .matchHeader('fiware-service', 'smartGondor')
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v2/entities/r2d2/attrs',
                utils.readExampleFile('./test/unit/ngsi20/examples/contextRequests/updateContextCommandFinish.json'))
                .reply(204);
    ...
    describe('When an error command arrives from the south bound for a registered command', function() {
        beforeEach(function(done) {
            statusAttributeMock = nock('http://192.168.1.1:1026')
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v2/entities/r2d2/attrs',
                utils.readExampleFile('./test/unit/ngsi20/examples/contextRequests/updateContextCommandError.json'))
                .reply(204);
