...
describe('Polling commands', function() {
    beforeEach(function(done) {
        ...
        contextBrokerMock = nock('http://192.168.1.1:1026')
            ...
            .post('/NGSI9/registerContext'/*,
                ...
                './test/unit/ngsi20/examples/contextAvailabilityRequests/registerIoTAgentCommands.json')*/)
            .reply(200,
                utils.readExampleFile(
    ...
    describe('When a command arrives with multiple values in the value field', function() {
        ...
        it('should return a 204 OK both in HTTP and in the status code', function(done) {
            iotAgentLib.setCommandHandler(function(id, type, service, subservice, attributes, callback) {
                callback(null);
            });
    ...
    describe('When a polling command expires', function() {
        ...
        beforeEach(function(done) {
            ...
            statusAttributeMock
                ...
                .matchHeader('fiware-servicepath', 'gardens')
                .post('/v2/entities/Robot:r2d2/attrs',
                    utils.readExampleFile('./test/unit/ngsi20/examples/contextRequests/updateContextCommandExpired.json'))
                .reply(204);
