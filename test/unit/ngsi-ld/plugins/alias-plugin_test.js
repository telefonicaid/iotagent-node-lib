        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .patch('/ngsi-ld/v1/entities/light1/attrs', utils.readExampleFile(
                    './test/unit/ngsi-ld/examples/contextRequests/updateContextAliasPlugin1.json'))
                .query({type: 'Light'})
                .reply(204);
        });
    ...
    describe('When an update comes for attributes with aliases and a different type', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                .matchHeader('fiware-service', 'smartGondor')
                .patch('/ngsi-ld/v1/entities/light1/attrs', utils.readExampleFile(
                    './test/unit/ngsi-ld/examples/contextRequests/updateContextAliasPlugin2.json'))
                .query({type: 'Light'})
                .reply(204);
        });
    ...
    describe('When an update comes for attributes with aliases and integer type', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                .matchHeader('fiware-service', 'smartGondor')
                .patch('/ngsi-ld/v1/entities/light1/attrs', utils.readExampleFile(
                    './test/unit/ngsi-ld/examples/contextRequests/updateContextAliasPlugin3.json'))
                .query({type: 'Light'})
                .reply(204);
        });
    ...
    describe('When an update comes for attributes with aliases and float type', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                .matchHeader('fiware-service', 'smartGondor')
                .patch('/ngsi-ld/v1/entities/light1/attrs', utils.readExampleFile(
                    './test/unit/ngsi-ld/examples/contextRequests/updateContextAliasPlugin4.json'))
                .query({type: 'Light'})
                .reply(204);
        });
    ...
    describe('When an update comes for attributes with aliases and boolean type', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                .matchHeader('fiware-service', 'smartGondor')
                .patch('/ngsi-ld/v1/entities/light1/attrs', utils.readExampleFile(
                    './test/unit/ngsi-ld/examples/contextRequests/updateContextAliasPlugin5.json'))
                .query({type: 'Light'})
                .reply(204);
        });
    ...
    describe('When an update comes for attributes with aliases and None type', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                .matchHeader('fiware-service', 'smartGondor')
                .patch('/ngsi-ld/v1/entities/light1/attrs', utils.readExampleFile(
                    './test/unit/ngsi-ld/examples/contextRequests/updateContextAliasPlugin6.json'))
                .query({type: 'Light'})
                .reply(204);
        });
    ...
    describe('When an update comes for attributes with aliases and Object type, but value is String', function() {
        ...
        beforeEach(function() {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                .matchHeader('fiware-service', 'smartGondor')
                .patch('/ngsi-ld/v1/entities/light1/attrs', utils.readExampleFile(
                    './test/unit/ngsi-ld/examples/contextRequests/updateContextAliasPlugin9.json'))
                .query({type: 'Light'})
                .reply(204);
        });
