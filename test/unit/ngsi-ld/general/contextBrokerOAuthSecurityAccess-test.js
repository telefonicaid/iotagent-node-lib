    ...
    describe('When subscriptions are used on a protected Context Broker', function() {
          beforeEach(function(done) {
            ...
            iotAgentLib.activate(iotAgentConfig, function() {
                ...
                contextBrokerMock
                .post('/ngsi-ld/v1/csourceRegistrations/', utils.readExampleFile(
                ...
                contextBrokerMock
                    .post('/ngsi-ld/v1/subscriptions/',
                        utils.readExampleFile('./test/unit/ngsi-ld/examples' +
                            '/subscriptionRequests/simpleSubscriptionRequest2.json'))
                    .matchHeader('Authorization', 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJ3cHdWclJ3')
...
describe('NGSI-LD - Secured access to the Context Broker with OAuth2 provider (FIWARE Keyrock IDM)' +
    ...
    describe('When a measure is sent to the Context Broker via an Update Context operation', function() {
        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://unexistentHost:1026')
                ...
                .matchHeader('Authorization', 'Bearer c1b752e377680acd1349a3ed59db855a1db07605')
                .patch('/ngsi-ld/v1/entities/machine1/attrs',
                    utils.readExampleFile('./test/unit/ngsi-ld/examples/contextRequests/updateContext3WithStatic.json'))
        ...
        beforeEach(function(done) {
            ...
            contextBrokerMock3 = nock('http://unexistentHost:1026')
                ...
                .patch('/ngsi-ld/v1/entities/Light1/attrs', utils.readExampleFile(
                    './test/unit/ngsi-ld/examples/contextRequests/updateContext4.json'))
                .query({type: 'SensorMachine'})
                .reply(204, {});
