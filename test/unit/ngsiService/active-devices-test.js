...
describe('Active attributes test', function() {
                ...
                contextBrokerMock = nock('http://192.168.1.1:1026')
                    ...
                    .post(
                        ...
                        utils.readExampleFile(
                            './test/unit/examples/contextRequests/updateContextTimestampTimezone.json'
                        )
                    )
                    .reply(
                        200,
            ...
            beforeEach(function(done) {
                ...
                contextBrokerMock = nock('http://192.168.1.1:1026')
                    ...
                    .post(
                        '/v1/updateContext',
                        utils.readExampleFile(
                            './test/unit/examples/contextRequests/updateContextTimestampOverride.json'
                        )
                    )
                    .reply(
                        200,
    ...
    describe('When the Context Broker returns an HTTP error code updating an entity', function() {
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .reply(200, utils.readExampleFile('./test/unit/examples/contextResponses/updateContext1Failed.json'));
    ...
    describe('When the Context Broker returns an application error code updating an entity', function() {
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .reply(200, utils.readExampleFile('./test/unit/examples/contextResponses/updateContext2Failed.json'));
    ...
    describe('When there is a transport error connecting to the Context Broker', function() {
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .reply(500, utils.readExampleFile('./test/unit/examples/contextResponses/updateContext2Failed.json'));
    ...
    describe(
        'When the IoT Agent receives new information from a device and CB' + 'is defined using environment variables',
        function() {
            beforeEach(function(done) {
