...
function update(entity, typeInformation, callback) {
    ...
    try {
        ...
        // Add static attrs from typeInformation into entity to be used by attrs with expressions
        ...
        // Remove static attrs from attsArray (will not propaged in an update entity)
        if (typeInformation.static) {
            typeInformation.static.forEach(function (att) {
                attsArray = attsArray.filter(function (a) {
