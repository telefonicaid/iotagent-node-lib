...
function processEnvironmentVariables() {
    ...
    if (process.env.IOTA_USE_CMD_BY_SUBS) {
        config.useCmdBySubs = process.env.IOTA_USE_CMD_BY_SUBS === 'true';
    } else {
        config.useCmdBySubs = config.useCmdBySubs === true;
    }
}
