...
function loadContextRoutes(router, name) {
    router.post('/iot/agents/' + name + '/services', checkHeaders, checkBody(templateGroup), handleCreateDeviceGroup);
    router.get('/iot/agents/' + name + '/services', checkHeaders, handleListDeviceGroups);
    router.put('/iot/agents/' + name + '/services', checkHeaders, handleModifyDeviceGroups);
    router.delete('/iot/agents/' + name + '/services', checkHeaders, handleDeleteDeviceGroups);
}
