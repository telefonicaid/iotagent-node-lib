 ...
 *
 * @param {String} resource             Group service name.
 * @param {String} apikey               Group subservice name.
 */
function remove(resource, apikey, callback) {
 ...
 *
 * @param {String} resource             Group resource name.
 * @param {String} apikey               Group apikey name.
 * @param {Object} body                 New body containing the attributes to change.
 */
function update(resource, apikey, body, callback) {
    function extractId(deviceGroup, callback) {
