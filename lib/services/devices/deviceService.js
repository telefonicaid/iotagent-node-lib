...
function updateRegisterDevice(deviceObj, callback) {
    ...
    function mixAttributeArrays(oldArray, newArray) {
        var oldActiveKeys,
            newActiveKeys,
            updateKeys,
            result;
    ...
    function extractDeviceDifference(newDevice, oldDevice, callback) {
        ...
        deviceData.active = mixAttributeArrays(oldDevice.active, newDevice.active);
        deviceData.lazy = mixAttributeArrays(oldDevice.lazy, newDevice.lazy);
        deviceData.commands = mixAttributeArrays(oldDevice.commands, newDevice.commands);
