...
function mergeDeviceWithConfiguration(fields, defaults, deviceData, configuration, callback) {
    ...
    if (configuration && configuration.endpoint !== undefined && deviceData.endpoint === undefined) {
        deviceData.endpoint = configuration.endpoint;
    }
    if (configuration && configuration.transport !== undefined && deviceData.transport === undefined) {
        deviceData.transport = configuration.transport;
    }
