...
function mergeDeviceWithConfiguration(fields, defaults, deviceData, configuration, callback) {
    ...
    if (configuration && configuration.autoprovision && deviceData.autoprovision === undefined) {
    ...
    if (configuration && configuration.explicitAttrs && deviceData.explicitAttrs === undefined) {
