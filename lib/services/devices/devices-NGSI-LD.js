...
/**
 * Creates the response handler for the update entity request using NGSI-LD. This handler basically deals with the errors
...
function updateEntityNgsiLD(deviceData, updatedDevice, callback) {
    var options = {
        url: config.getConfig().contextBroker.url + 
