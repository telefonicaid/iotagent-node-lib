...
function sendUnregistrationsNgsi2(deviceData, callback) {
    ...
    if (deviceData.registrationId) {
        ...
        return deviceService.executeWithSecurity(
            options,
            deviceData,
...
function sendRegistrationsNgsiLD(unregister, deviceData, callback) {
    ...
    var options = {
        ...
        json: {
            ...
            information: [
                {
                    entities: [{type: deviceData.type, id: String(deviceData.name)}],
    ...
    deviceService.executeWithSecurity(
        options,
        deviceData,
        createRegistrationHandlerNgsiLD(unregister, deviceData, callback));
}
