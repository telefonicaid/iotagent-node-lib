...
exports.create = alarmsInt(constants.MONGO_ALARM + '_1', intoTrans(context, createGroup));
exports.list = alarmsInt(constants.MONGO_ALARM + '_2', intoTrans(context, listGroups));
exports.init = alarmsInt(constants.MONGO_ALARM + '_3', intoTrans(context, init));
exports.find = alarmsInt(constants.MONGO_ALARM + '_4', intoTrans(context, find));
exports.findType = alarmsInt(
    constants.MONGO_ALARM + '_5',
...
exports.findBy = alarmsInt(constants.MONGO_ALARM + '_6', intoTrans(context, findBy));
exports.get = alarmsInt(constants.MONGO_ALARM + '_7', intoTrans(context, findBy(['resource', 'apikey'])));
exports.getSilently = intoTrans(context, findBy(['resource', 'apikey']));
exports.getType = alarmsInt(constants.MONGO_ALARM + '_8', intoTrans(context, findBy(['type'])));
exports.getTypeSilently = intoTrans(context, findBy(['type']));
exports.update = alarmsInt(constants.MONGO_ALARM + '_9', intoTrans(context, update));
