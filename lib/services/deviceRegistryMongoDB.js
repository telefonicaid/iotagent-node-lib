...
/**
 * Handler for save device operations.
 *
 * @param {Object} error        Error object in case there was any MongoDB error
 * @param {Object} deviceDAO    DAO representing the device in Mongoose
 */
...
function storeDevice(newDevice, callback) {
    var deviceObj = new Device.model(),
        attributeList = ['id', 'type', 'name', 'service', 'subservice', 'lazy',
