...
function convertNGSIv2ToLD(attr){
    ...
    switch (attr.type.toLowerCase()) {
        ...
        case 'datetime':
            ...
            break;
        case 'date':
            obj.value = { '@type': "Date", '@value': moment(attr.value).utc().format(moment.HTML5_FMT.DATE)};
            break;
        case 'time':
            obj.value = { '@type': "Time", '@value': moment(attr.value).utc().format(moment.HTML5_FMT.TIME_SECONDS)};
            break;
        default:
