...
function sendUpdateValue(entityName, attributes, typeInformation, token, callback) {
    ...
    if (typeInformation.storeLastMeasure) {
        ...
        let originalMeasure = typeInformation.orignalMeasure ? typeInformation.orignalMeasure : attributes;
        deviceService.storeDeviceField('lastMeasure', typeInformation.orignalMeasure, typeInformation, function () {
