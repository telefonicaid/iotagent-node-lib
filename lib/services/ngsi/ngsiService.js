...
function sendUpdateValue(entityName, attributes, typeInformation, token, callback) {
    ...
    if (typeInformation.storeLastMeasure) {
        ...
        let originalMeasure = typeInformation.originalMeasure ? typeInformation.originalMeasure : attributes;
        deviceService.storeDeviceField('lastMeasure', typeInformation.originalMeasure, typeInformation, function () {
