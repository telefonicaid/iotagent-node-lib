...
function sendUpdateValue(entityName, attributes, typeInformation, token, callback) {
    ...
    const newCallback2 = entityHandler.sendUpdateValue(entityName, attributes, typeInformation, token, newCallback);
    deviceService.storeLastMeasure(attributes, typeInformation, newCallback2);
}
