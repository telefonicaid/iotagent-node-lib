...
function sendUpdateValue(entityName, attributes, typeInformation, token, callback) {
    ...
    const updateCallback = entityHandler.sendUpdateValue(entityName, attributes, typeInformation, token, newCallback);
    deviceService.storeLastMeasure(attributes, typeInformation, updateCallback);
}
