...
function removeHiddenAttrsFromMultiEntity(entities, typeInformation) {
    ...
    if (typeInformation.explicitAttrs && typeInformation.explicitAttrs.isPrototypeOf(Boolean)) {
    ...
    } else if (typeInformation.explicitAttrs && typeInformation.explicitAttrs.isPrototypeOf(String)) {
        entities.forEach((entity) => {
            ...
            if (res !== null) {
                ...
                explicitAttrsList.concat(typeInformation.explicitAttrs);
            }
        });
    }
