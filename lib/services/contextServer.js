 ...
 *
 * @param {Object} response         Response object representing the JSON response for a NGSI operation.
 * @return {String}                String representation of the XML Response.
 */
        ...
        async.series(updateActions, function(error, result) {
            if (error) {
                ...
                if (req.is('application/xml')) {
                    ...
                    res
                        .status(200)
                        .send(generateXmlResponse(createUpdateResponse(req, res, result)));
                } else {
