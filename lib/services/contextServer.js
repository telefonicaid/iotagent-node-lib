...
function loadContextRoutes(router) {
    ...
    router.post('/NGSI10/updateContext', ensureType, readBody, validateJson(updateContextTemplate), handleUpdate);
    router.post('/NGSI10/queryContext', ensureType, readBody, validateJson(queryContextTemplate), handleQuery);
}
