...
function loadContextRoutes(router) {
    ...
    router.post('/NGSI10/updateContext', ensureJson, validateBody(updateContextTemplate), handleUpdate);
    router.post('/NGSI10/queryContext', ensureJson, validateBody(queryContextTemplate), handleQuery);
}
