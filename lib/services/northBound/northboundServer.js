...
const configGroupProvisioning = require('./deviceConfigGroupAdministrationServer');
...
function start(config, callback) {
    ...
    configGroupProvisioning.loadContextRoutes(northboundServer.router);
...
exports.setGroupConfigurationHandler = intoTrans(context, configGroupProvisioning.setConfigurationHandler);
exports.setRemoveConfigurationHandler = intoTrans(context, groupProvisioning.setRemoveConfigurationHandler);
exports.setRemoveGroupConfigurationHandler = intoTrans(context, configGroupProvisioning.setRemoveConfigurationHandler);
