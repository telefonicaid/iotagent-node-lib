...
var http = require('http'),
    ...
    contextServerNgsi2 = require('./contextServerNgsi2'),
    deviceServiceNgsi2 = require('./../devices/deviceServiceNgsi2'),
...
function start(config, callback) {
    ...
    if (config.contextBroker &&
        ...
        contextServer = contextServerNgsi2;
        deviceProvisioning.setDeviceService(deviceServiceNgsi2);
    }
...
function setUpdateHandler(newHandler) {
    contextServer.setUpdateHandler(newHandler);
}

function setQueryHandler(newHandler) {
    contextServer.setQueryHandler(newHandler);
}


function setCommandHandler(newHandler) {
    contextServer.setCommandHandler(newHandler);
}

function setNotificationHandler(newHandler) {
    contextServer.setNotificationHandler(newHandler);
}

function addNotificationMiddleware(newMiddleware) {
    contextServer.addNotificationMiddleware(newMiddleware);
}
...
exports.addNotificationMiddleware = addNotificationMiddleware;
exports.clear = clear;
