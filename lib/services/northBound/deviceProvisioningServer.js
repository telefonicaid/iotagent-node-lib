...
function handleProvision(req, res, next) {
    ...
    function fillDeviceData(service, subservice, body, callback) {
        ...
        callback(null, {
            ...
            commandLegacy: body['commandLegacy']
        });
    }
...
function toProvisioningAPIFormat(device) {
    ...
    return {
        ...
        commandLegacy: device.commandLegacy
    };
}
...
function handleRemoveDevice(req, res, next) {
    ...
    function getDevice(deviceId, service, subservice, callback){
        deviceService.getDevice(deviceId, service, subservice,
            function(error, device) {
                if (error) {
                    callback(error);
                } else if (device) {
    ...
    async.waterfall([
        ...
        apply(unregisterDevice, req.params.deviceId,
            req.headers['fiware-service'], req.headers['fiware-servicepath'])], function (error) {
