...
function loadContextRoutes(router) {
    ...
    var updateMiddlewaresNgsi1 = [
        ...
        queryMiddlewaresNgsi2 = [handleQueryNgsi2, queryErrorHandlingNgsi2],
        updatePathsNgsi1 = ['/v1/updateContext', '/NGSI10/updateContext', '//updateContext'],
        updatePathsNgsi2 = ['/v2/op/update', '//op/update'],
        queryPathsNgsi1 = ['/v1/queryContext', '/NGSI10/queryContext', '//queryContext'],
        queryPathsNgsi2 = ['/v2/op/query', '//op/query'];
