...
/**
 * Express middleware to manage incoming notification requests using NGSIv1.
 *
 * @param {Object} req              Request that was handled in first place.
 * @param {Object} res              Response that will be sent.
 */
...
/**
 * Express middleware to manage incoming notification requests using NGSIv2.
 *
 * @param {Object} req              Request that was handled in first place.
 * @param {Object} res              Response that will be sent.
 */
...
/**
 * Error handler for NGSIv1 context query requests.
 *
...
/**
 * Error handler for NGSIv1 update requests.
 *
 * @param {Object} error            Incoming error
 * @param {Object} req              Request that was handled in first place.
 * @param {Object} res              Response that will be sent.
...
function loadContextRoutes(router) {
    ...
    if (config.checkNgsiLD()) {
        ...
        for (i = 0; i < updatePathsNgsiLD.length; i++) {
            router.patch(updatePathsNgsiLD[i], updateMiddlewaresNgsiLD);
        }
        for (i = 0; i < queryPathsNgsiLD.length; i++) {
            router.get(queryPathsNgsiLD[i], queryMiddlewaresNgsiLD);
        }
        router.post('/notify', [
            middlewares.ensureType,
